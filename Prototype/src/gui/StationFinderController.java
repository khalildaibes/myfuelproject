...
public class StationFinderController 
{
    ...
    @FXML
    void AppStoreBtn(ActionEvent event) throws IOException, URISyntaxException
    {
    	Desktop d=Desktop.getDesktop();
    	d.browse(new URI("https://apps.apple.com/us/app/gasbuddy-find-cheap-gas/id406719683"));
    }

    @FXML
    void googlePlayBtn(ActionEvent event) throws IOException, URISyntaxException 
    {
    	Desktop d=Desktop.getDesktop();
    	d.browse(new URI("https://play.google.com/store/apps/details?id=de.pnpq.fuellocator&hl=en_US"));
    }
