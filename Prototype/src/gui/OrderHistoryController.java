...
public class OrderHistoryController {
    ...
    @FXML
    private TableView<?> orderHistorytbl;

    @FXML
    private TableColumn<?, ?> orderIDCulm;

    @FXML
    private TableColumn<?, ?> clientNumberCulm;

    @FXML
    private TableColumn<?, ?> productNameCulm;

    @FXML
    private TableColumn<?, ?> orderDateCulm;

    @FXML
    private TableColumn<?, ?> amountCulm;

    @FXML
    private TableColumn<?, ?> totalCulm;
