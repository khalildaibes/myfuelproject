...
public class HomeFuelController
{
	@FXML
	...
	@FXML
	private Button addToCartBtn=null;
	@FXML
...
public void tracker(ActionEvent event) throws Exception 
	...
	public void addToCartBtn(ActionEvent event) throws Exception 
	{
		FXMLLoader loader = new FXMLLoader();
		...
		Pane root = loader.load(getClass().getResource("/gui/addedToCart2.fxml").openStream());
		
		Scene scene = new Scene(root);			
		primaryStage.setTitle("Added To Cart Successfully!");
